...
| ------ | --- | -------- | -------- | -------   | ------- |
| [MCP](http://en.wikipedia.org/wiki/MCP_%28Burroughs_Large_Systems%29), also [here](http://en.wikipedia.org/wiki/Burroughs_large_systems) and [here](http://ed-thelen.org/comp-hist/B5000-AlgolRWaychoff.html) ([via](http://www.metafilter.com/122701/STORIES-ABOUT-THE-B5000-AND-PEOPLE-WHO-WERE-THERE-By-Richard-Waychoff)) | 1961-- | Algol (ESPOL) | Bare machine | Burroughs B5000 | Data processing |
