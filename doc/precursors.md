...
| [Oberon](http://en.wikipedia.org/wiki/Oberon_%28operating_system%29), also [here](http://www.ethoberon.ethz.ch/) and [here](www.ethoberon.ethz.ch/WirthPubl/ProjectOberon.pdf) and [here](http://ignorethecode.net/blog/2009/04/22/oberon/) and [here](http://www.ethoberon.ethz.ch/SYSTEM.html) and [here](http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.31.4534) and [here](http://news.ycombinator.com/item?id=593995) | late 1980s | Oberon | Bare machine | ETH Ceres, ... (NS32032 processor) | Programming, Electronics CAD, "an entire system from scratch, ... that can be ... understood as a whole" |
...
| [SqueakNOS](http://squeaknos.blogspot.com/), also [here](http://sourceforge.net/projects/squeaknos/) and [here](http://wiki.squeak.org/squeak/1762) | 2006 -- | Smalltalk | Bare machine | x86, various | "Squeak No Operating System", "We want to get rid of the operating system under Squeak" |
...
| [Armpit Scheme](http://armpit.sourceforge.net/) and other embedded Schemes | 2006 -- | Scheme | Bare Machine | ARM (BeagleBoard XM, etc.) | "Scheme to the metal" ... running without any other OS. ... turning the MCU into a rudimentary Scheme machine. " |
| [LispmFPGA](http://www.aviduratas.de/lisp/lispmfpga/), also [here](https://groups.google.com/forum/?fromgroups=#!topic/comp.lang.lisp/36_qKNErHAg) | 2006 -- | Lisp (CL subset) | Bare FPGA | Spartan 3 Xilinx FPGA, Digilent Spartan 3 Starter Kit | "a CPU with Lisp optimized instruction set together with a complete set of system software written in Lisp" |
| [lisPImachine](http://lispm.dyndns.org/), also [here](http://lispm.dyndns.org/ccl) | 2012 | Lisp (Clozure CL) | Native OS | Raspberry Pi, Linux/Raspian | "Linux on the command line, ... the SLIME development environment for Common Lisp based on Emacs and ... Clozure Common Lisp" |
...
| [eLua](http://www.eluaproject.net/doc/v0.8/en_arch_overview.html) also [here](http://eluabrain.blogspot.fr/) | 2011 (?) -- | Bare machine | eLuaBrain (Cortex-M3) and many more | embedded software ... with the power of Lua ... on a wide range of microcontroller architectures" |
