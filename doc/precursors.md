...
| [kOS](http://kparc.com/), also [here](http://www.jsoftware.com/jwiki/Community/Conference2012#Schedule) and [here](http://coding-is-like-cooking.info/tag/array-languages/) | P | 2012 | [k](http://archive.vector.org.uk/art10010830) (like APL), C | Bare machine (?) | "k requires nothing. it uses no libraries and has no dependencies." | "for desktop, cloud, pad and phone, e.g. a replacement for webkit and android" | 
