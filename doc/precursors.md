...
| [JavaOS](http://en.wikipedia.org/wiki/JavaOS), also [here](http://www.amazon.com/Inside-JavaOS-TM-Operating-System/dp/0201183935)| 1996 -- 1999 | Java | Bare Machine | Sun JavaStation (microSPARC), various | Network computers, thin clients, embedded systems |
...
| [JONESFORTH](http://rwmj.wordpress.com/2010/08/07/jonesforth-git-repository/), also [here](http://git.annexia.org/?p=jonesforth.git;a=summary) and [here](https://github.com/nornagon/jonesforth) | 2007 -- | FORTH | Native OS | Linux | " a FORTH program in 2,000 lines ... which will boot and provide an entire development environment (inc. editor, compiler etc) on bare hardware" |
