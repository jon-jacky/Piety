...
| [zero.rs](https://github.com/pcwalton/zero.rs) | P | 2013 | Rust | Native OS || C stdlib | "create almost completely freestanding Rust programs. The only dependencies are ... malloc, free, abort, memcpy, and memcmp" |
| [rustboot](https://github.com/charliesome/rustboot) | P | 2013 | Rust | Bare machine | QEMU | "A tiny 32 bit kernel written in Rust" |
| [GoFY](http://gofy.cat-v.org/), also [here](http://code.google.com/p/gofy/) and [here](https://github.com/machinaut/gofy) | 2011 -- | Go | Bare Machine | "x86-64 only" |  "GoFY is a new revolutionary radical operating system that aims to break all rules" |
