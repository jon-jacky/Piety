...
| [XANA](https://code.google.com/p/projectxana/), also at [OSDev](http://forum.osdev.org/viewtopic.php?f=1&t=7695&start=225), don't miss this [memoir](http://forum.osdev.org/viewtopic.php?f=1&t=7695&start=225) | P | 2007 | D, Lua | Bare machine | i386 | "borrowing ... basic starting points from Project Xanadu. ... (user) interfacebased on Xanadu's 'ZigZag'" "keyboard support ... a ramdisk with a novel (though ususable) filesystem, and experimental hard disk support" |
