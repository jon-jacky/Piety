...
| [Interim](http://interim.mntmn.com/), also [Github](https://github.com/mntmn/interim) and [paper](http://dump.mntmn.com/interim-paper/) | P | 2015 | Lisp (custom) | Bare machine, Native OS | Raspberry Pi 2 (ARMv7), Olimex Olinuxino (ARMv5), ARM5+ Linux, Intel/AMD x64 Linux | "minimalism ... steals from ... Lisp Machines ... and Plan 9" |
