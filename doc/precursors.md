...
| [Pardus-Linux](http://en.pardus-wiki.org/Main_Page), also [here](https://github.com/Pardus-Linux) and [here](http://blogs.kde.org/2009/07/12/interesting-things-i-saw-gcds-pardus-linux) | R | 2005 -- | Python | Native OS | Linux | Linux distribution that uses Python scripts for package management, startup, and configuration |
