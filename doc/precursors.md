...
| [Project Oberon](http://www.inf.ethz.ch/personal/wirth/ProjectOberon/) (New Edition 2013), also [abstract](http://wirth-symposium.ethz.ch/speakers.html#Wirth) and [slides](http://wirth-symposium.ethz.ch/slides/wirth.pdf) and [picture](http://www.schleibinger.com/bilder/oberon.jpg) | A | 2013 | Oberon | Bare Machine | Custom CPU on FPGA (Xilinx Spartan 3, Digilent board),  [OberonStation](http://oberonstation.x10.mx/) computer | "extend the desire for simplicity and regularity to the hardware" |
