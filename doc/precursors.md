...
| [IGOR](http://opencores.org/project,igor), also [here]http://www.idi.ntnu.no/news/index.php?news=163) and [here](http://www.flickr.com/photos/kaitorge/sets/72157609445719327/show/) | 2008 | Lisp | Bare machine (FPGA) | Custom PCB with FPGA running custom microcode | "Fourteen students have collaborated in constructing a Lisp machine (IGOR) from scratch."|
