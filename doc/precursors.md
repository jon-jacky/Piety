...
| ------ | --- | -------- | -------- | -------   | ------- |
| [MCP](http://en.wikipedia.org/wiki/MCP_%28Burroughs_Large_Systems%29), also [here](http://en.wikipedia.org/wiki/Burroughs_large_systems) and [here](http://ed-thelen.org/comp-hist/B5000-AlgolRWaychoff.html) ([via](http://www.metafilter.com/122701/STORIES-ABOUT-THE-B5000-AND-PEOPLE-WHO-WERE-THERE-By-Richard-Waychoff)), don't miss [this](archive.computerhistory.org/resources/text/Knuth_Don_X4100/PDF_index/k-2-pdf/k-2-c1039-ALGOL-B205.pdf) and [this](http://www.cs.virginia.edu/brochure/images/manuals/b5000/brochure/b5000_broch.html) | 1961-- | Algol (ESPOL) | Bare machine | Burroughs B5000 | Data processing |
...
| [Oberon](http://en.wikipedia.org/wiki/Oberon_%28operating_system%29), also [here](http://www.ethoberon.ethz.ch/) and [here](http://ignorethecode.net/blog/2009/04/22/oberon/) and [here](http://news.ycombinator.com/item?id=593995) | late 1980s | Oberon | Bare machine | ETH Ceres, ... (NS32032 processor) | Programming, Electronics CAD, "an entire system from scratch, ... that can be ... understood as a whole" |
