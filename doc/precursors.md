...
| [Pardus-Linux](https://github.com/Pardus-Linux), also [here](http://blogs.kde.org/2009/07/12/interesting-things-i-saw-gcds-pardus-linux) | R | 2006 -- | Python | Native OS | Linux | Linux distribution that uses Python scripts for package management, startup, and configuration |
