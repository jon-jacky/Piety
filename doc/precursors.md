...
| [Alto OS](http://research.microsoft.com/apps/pubs/default.aspx?id=68223), also [here](http://research.microsoft.com/en-us/um/people/blampson/38-AltoSoftware/WebPage.html) and [here](research.microsoft.com/en-us/um/people/blampson/38-AltoSoftware/ThackerAltoHardware.pdf) | R | 1973 -- | BCPL | Bare machine | Xerox Alto (purpose built) | "open design, which allows any part of the system to be replaced by a client program" |
...
| [Project Oberon](http://www.inf.ethz.ch/personal/wirth/ProjectOberon/) (New Editiong 2013) | A | 2013 | Oberon | Bare Machine | Custom CPU on FPGA (Xilinx Spartan 3, Digilent board) | "extend the desire for simplicity and regularity to the hardware" |
...
| [Mirage](http://www.openmirage.org/), also [here](http://www.openmirage.org/wiki/papers) and [here](http://dl.acm.org/citation.cfm?id=1863114) and [here](http://www.xenproject.org/developers/teams/mirage-os.html) and [here](http://www.xenproject.org/component/mtree/research/111-unikernels-library-operating-systems-for-the-cloud.html?Itemid=) and [here](http://blog.xen.org/index.php/2013/12/09/announcing-the-1-0-release-of-mirage-os/) | A | 2006 -- | O'Caml | Virtual Machine | Xen hypervisor | "I/O intensive cloud services ... minimize the use and cost of cloud resources" |
...
| [kOS](http://kparc.com/), also [here](http://www.jsoftware.com/jwiki/Community/Conference2012#Schedule) and [here](http://coding-is-like-cooking.info/tag/array-languages/) | P | 2012 | k (like APL), C | Bare machine (?) | "k requires nothing. it uses no libraries and has no dependencies." | "for desktop, cloud, pad and phone, e.g. a replacement for webkit and android" | 
...
| [rustboot](https://github.com/charliesome/rustboot) | P | 2013 | Rust | Bare machine | QEMU | "A tiny 32 bit kernel written in Rust" |
...
| [Urbit](http://www.urbit.org/), also [here](http://www.urbit.org/2013/09/24/urbit-intro.html) and [here](https://github.com/urbit) and [here](http://www.youtube.com/watch?v=6S8JFoT6BEM) and [here](http://alexkrupp.typepad.com/sensemaking/2013/12/a-brief-introduction-to-urbit.html) | P | 2013 | [Nock](http://www.urbit.org/2013/08/22/Chapter-2-nock.html) "a combinator automaton", [Hoon](http://www.urbit.org/2013/08/22/Chapter-4-syntax.html) "FP made stupid" | Native OS | Linux, OS X | "not much sign of a connection to ordinary Earth computing" |
