...
| [Py9P](http://repo.cat-v.org/py9p/) | File system | Source, API | "a pure Python implementation of the 9P (in particular 9p2000) distributed file system protocol ... includes both client and server APIs, and ... authentication" | 
