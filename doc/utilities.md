...
|[Python Prompt Toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) | Command line interface library | Source, API | "a replacement for readline, but it can be much more than that" "Multi-line input editing" "Emacs and Vi key bindings" |
