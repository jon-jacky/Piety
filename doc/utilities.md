...
| [uzbl](http://uzbl.org/), also [here](https://github.com/Dieterbe/uzbl) | Browser | Wrapper | "Uses WebKitGtk+ for rendering and network interaction", "Uses a set of scripts (mostly Python) ... so things
