...
|[teeceepee](https://github.com/jvns/teeceepee), also [here](http://jvns.ca/projects/#python-tcp-stack) | Network | Source, API | "tiny TCP stack in pure Python, for fun and learning ...  built on top of *scapy* ... get a webpage in *examples/curl.py* " |
