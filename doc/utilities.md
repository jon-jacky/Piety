...
| [Evergreen](https://crate.io/packages/evergreen/), also [here](https://evergreen.readthedocs.org/en/latest/) and [here](https://github.com/saghul/evergreen) and [here](http://code.saghul.net/index.php/2013/04/22/evergreen-cooperative-multitasking-and-io-for-python/) | Cooperative multitasking | Source, API | "driven by an event loop which will run the given tasks and i/o operations in a non-blocking manner while presenting the user a synchronous, blocking API","Ability to monkey patch standard library modules to make them cooperative".  Informed by [Tiwisted](http://twistedmatrix.com/trac/), [Tornado](http://www.tornadoweb.org/en/stable/), [Eventlet](http://eventlet.net/), [gevent](http://gevent.org/), [tulip](https://code.google.com/p/tulip/), and [Stackless](http://www.stackless.com/) |
