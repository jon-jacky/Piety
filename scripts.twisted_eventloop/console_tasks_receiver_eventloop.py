"""
console_tasks_receiver_eventloop.py - Create Piety console jobs, session 
 used by piety.twisted_eventloop

Similar to scripts.twisted/console_tasks_receiver.py, except 
it also assigns piety.eventloop.application = console.
