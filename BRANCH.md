...
- 16 Sep 2026: begin the *renames* branch of the *rewrite* branch:
  rename some modules and commands. Rename our flagship editor module
  from *pmacs* to *edsel*, rename our command to leave the REPL and
  resume display editing from *pm* to *ed*, and other renamings as
  needed or desired.
...
- 23 Jan 2025; Begin *browser* branch to write a text-only web browser
  closely integrated with the Piety editors, where downloaded web pages
...
- 23 Dec 2024: Begin *console* branch to enable Piety development using
  ...
  host desktop or shell.
 
- 11 Nov 2024: Merge the *edmore* branch back into the *rewrite* branch.
