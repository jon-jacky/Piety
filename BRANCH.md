...
*Piety/README.md*.  At this writing (Feb 2023) a total rewrite is
underway in the *rewrite* branch, to simplify the code and improve its
organization and clarity.  It might be quite a while before the code
in *rewrite* provides equivalent functionality to the code here in
